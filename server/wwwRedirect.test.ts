...
{
  // /api NOOIT omleiden. Een webhook-verzender volgt geen 301: die ziet een
  // 3xx, telt het als mislukte aflevering en stopt na zijn retry-window.
  // Zo viel de WhatsApp-koppeling stil toen deze redirect live ging.
