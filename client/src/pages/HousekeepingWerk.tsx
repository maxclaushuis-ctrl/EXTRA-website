        ...
        <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 pt-24 pb-16 sm:pt-28 sm:pb-20 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center w-full">
          <div>
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-1.5 mb-6 border border-white/20">
              ...
              <span className="text-white/90 text-xs font-semibold">Housekeeping werk via EXTRA</span>
            </div>
            ...
            <div className="mt-8 flex flex-wrap gap-2.5">
              {[
                ...
                { emoji: "🏨", label: "Tophotels in Amsterdam" },
                { emoji: "📅", label: "Flexibele diensten" },
              ].map(({ emoji, label }) => (
          ...
          <div className="relative flex justify-center items-center">
            <div className="relative w-full max-w-sm">
              <div className="rounded-3xl overflow-hidden shadow-2xl shadow-purple-900/40 border-4 border-white/20">
                <img src={housekeepingImg} alt="Housekeeping medewerker via EXTRA" className="w-full h-[380px] sm:h-[440px] object-cover" loading="eager" />
