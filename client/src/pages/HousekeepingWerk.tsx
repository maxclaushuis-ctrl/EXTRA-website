...
export default function HousekeepingWerk() {
  ...
  const taken = [
    { title: "Kamers schoonmaken", href: "/aanmelden", img: housekeepingImg, icon: Sparkles, desc: "Zorg dat elke kamer spic en span is voor de volgende gast." },
    { title: "Bedden opmaken", href: "/aanmelden", img: housekeepingBlogImg, icon: BedDouble, desc: "Van lakens wisselen tot een perfect opgemaakt bed met oog voor detail." },
    { title: "Kwaliteitscontrole", href: "/aanmelden", img: hotelImg, icon: ShieldCheck, desc: "Check of alles klopt voor de kwaliteitsstandaard van het hotel." },
    { title: "Amenities aanvullen", href: "/aanmelden", img: teamImg, icon: Layers, desc: "Zorg dat handdoeken en producten altijd aangevuld en netjes gepresenteerd zijn." },
  ];
          ...
          <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
            <RevealSection>
              <div className="text-center mb-16">
                <h2 className="text-3xl md:text-4xl font-black text-white mb-4" style={{ fontFamily: "'Poppins', sans-serif" }}>Wat doe je in housekeeping</h2>
