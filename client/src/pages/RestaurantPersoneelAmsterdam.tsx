...
import { ArrowRight, Building2, Check, Sparkles, Clock, Shield, Star } from "lucide-react";

export default function RestaurantPersoneelAmsterdam() {
  return (
      ...
      <main>
            ...
            <RevealSection>
              <div className="max-w-3xl">
                <span className="inline-flex items-center gap-2 text-purple-400 font-bold text-xs sm:text-sm uppercase tracking-widest mb-6 bg-purple-500/10 px-4 py-2 rounded-full border border-purple-500/20">
                  <Building2 className="w-4 h-4" /> Restaurant Branche
                </span>
                <h1 className="text-4xl sm:text-6xl lg:text-7xl font-black text-white leading-tight mb-8" style={{ fontFamily: "'Poppins', sans-serif" }}>
                  Je restaurant draait op <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400">goed personeel</span>
                </h1>
                <p className="text-lg sm:text-xl text-purple-100/70 mb-10 leading-relaxed max-w-2xl">
                  Ervaren bediening en keukenpersoneel voor uw restaurant in Amsterdam. Onze medewerkers zijn direct inzetbaar en gewend aan de hectiek van de horeca.
                </p>
        ...
        <section className="py-24 bg-[#0d0415]">
          <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
            <RevealSection className="mb-16">
              <h2 className="text-3xl sm:text-5xl font-black text-white mb-6">Wat wij leveren voor <span className="text-purple-500">restaurants</span></h2>
              <p className="text-lg text-purple-100/60 max-w-2xl">Kwaliteit aan tafel en in de keuken.</p>
            </RevealSection>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { title: "Bediening", icon: Star, desc: "Professionele kelners die gastvrijheid hoog in het vaandel hebben staan." },
                { title: "Barkrachten", icon: Clock, desc: "Snel en bekwaam barpersoneel dat de drukste spitsen aankan." },
                { title: "Keukenhulp", icon: Shield, desc: "Flexibele ondersteuning in de keuken, van mise-en-place tot afwas." },
              ].map((service, i) => (
        ...
        <section className="py-24 bg-[#0a0310] relative">
          <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
              ...
              {[
                { step: "01", title: "Behoefte", desc: "U geeft door hoeveel mensen u nodig heeft en voor welke functies." },
                { step: "02", title: "Bevestiging", desc: "Wij bevestigen de inzet van ons gekwalificeerde personeel." },
                { step: "03", title: "Kwaliteit", desc: "Uw restaurant draait soepel door met de extra inzet van ons team." },
              ].map((item, i) => (
        ...
        <section className="py-24 bg-gradient-to-r from-purple-900/40 to-pink-900/40 border-y border-white/5">
          <div className="max-w-4xl mx-auto px-5 text-center">
            <RevealSection>
              <h2 className="text-3xl sm:text-5xl font-black mb-8">Nooit meer onderbezet</h2>
              <p className="text-xl text-purple-100/70 mb-10">Met EXTRA vindt u direct het juiste restaurant personeel in Amsterdam.</p>
