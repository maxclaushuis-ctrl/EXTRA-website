...
import { ArrowRight, UtensilsCrossed, Check, Sparkles, Clock, Shield, Star } from "lucide-react";

export default function CateringPersoneelAmsterdam() {
  return (
      ...
      <main>
        ...
        <section className="py-24 bg-[#0d0415]">
          <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
            <RevealSection className="mb-16">
              <h2 className="text-3xl sm:text-5xl font-black text-white mb-6">Wat wij leveren voor <span className="text-purple-500">cateraars</span></h2>
              <p className="text-lg text-purple-100/60 max-w-2xl">Onze flexibele schil versterkt uw team waar nodig.</p>
            </RevealSection>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { title: "Keuken Personeel", icon: Star, desc: "Hulpkoks, basiskoks en afwasmedewerkers die direct mee kunnen draaien." },
                { title: "Partymanagers", icon: Shield, desc: "Ervaren krachten die de leiding nemen op locatie voor een perfecte uitvoering." },
                { title: "Service Medewerkers", icon: Clock, desc: "Snel en effectief personeel voor buffetten, diners en borrels." },
              ].map((service, i) => (
        ...
        <section className="py-24 bg-[#0a0310] relative">
          <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
              ...
              {[
                { step: "01", title: "Aanvraag", desc: "Geef uw behoeften door via ons platform of telefonisch." },
                { step: "02", title: "Selectie", desc: "Wij selecteren medewerkers die passen bij uw werkwijze." },
                { step: "03", title: "Support", desc: "Onze medewerkers versterken uw team op locatie." },
              ].map((item, i) => (
        ...
        <section className="py-24 bg-gradient-to-r from-purple-900/40 to-pink-900/40 border-y border-white/5">
          <div className="max-w-4xl mx-auto px-5 text-center">
            <RevealSection>
              <h2 className="text-3xl sm:text-5xl font-black mb-8">Capaciteit tekort?</h2>
              <p className="text-xl text-purple-100/70 mb-10">EXTRA is uw partner voor hoogwaardig catering personeel in Amsterdam.</p>
