...
const appScreens = [
  { key: "dashboard", img: screenDashboard, label: "Dashboard", alt: "Screenshot of the EXTRAATje dashboard in the restaurant staff app: points balance, bronze status and popular rewards" },
  ...
  { key: "leaderboard", img: screenRanglijst, label: "Leaderboard", alt: "Screenshot of the leaderboard in the EXTRAATje app showing restaurant staff members' point rankings" },
];
