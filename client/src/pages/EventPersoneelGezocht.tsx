...
const appScreens = [
  { key: "dashboard", img: screenDashboard, label: "Dashboard", alt: "Schermafbeelding van het EXTRAATje-dashboard in de app van eventmedewerkers: puntensaldo, bronsstatus en populaire beloningen" },
  { key: "beloningen", img: screenRewards, label: "Beloningen", alt: "Schermafbeelding van het beloningenoverzicht in de EXTRAATje-app, met te claimen cadeaus zoals een JBL-speaker en AirPods" },
  { key: "uitdagingen", img: screenUitdagingen, label: "Uitdagingen", alt: "Schermafbeelding van een actieve uitdaging in de EXTRAATje-app: extra punten verdienen door meer diensten te draaien" },
  { key: "ranglijst", img: screenRanglijst, label: "Ranglijst", alt: "Schermafbeelding van de ranglijst in de EXTRAATje-app met de puntenposities van eventmedewerkers" },
];
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 w-full pt-28 sm:pt-32 pb-36 sm:pb-32">
          <div className="max-w-2xl">
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-6xl text-white leading-[1.1] mb-5 sm:mb-8" style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 900 }}>
              Eventpersoneel nodig?<br />
              Wij shaken het<br />
              <span className="relative inline-block">
                <span className="relative z-10">voor elkaar.</span>
