...
import logoLofi from "../assets/pitch/logo-lofi.png";
...
export default function BrochureLofi() {
        ...
        {currentSlide === 0 && (
          ...
          >
            ...
            >
              ...
              <span className="text-3xl md:text-4xl text-gray-500 font-light" style={{ fontFamily: 'Poppins' }}>×</span>
              <img 
                src={logoLofi} 
                alt="Lofi" 
            ...
            <motion.p
              ...
              className="text-xl md:text-2xl text-gray-400 mb-12 text-center max-w-3xl"
              style={{ fontFamily: 'Poppins' }}
            >
              Vertrouwd personeel dat je locatie kent — keer op keer
            </motion.p>
            ...
            >
              {[
                { icon: Repeat, text: "Vaste medewerkers" },
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl">
              ...
              >
                <div className="inline-flex items-center gap-2 bg-cyan-600/20 border border-cyan-500/40 rounded-full px-4 py-2 mb-6">
                  ...
                  <span className="text-cyan-300 text-sm" style={{ fontFamily: 'Poppins' }}>Speciaal voor Lofi</span>
                </div>
                <h2 className="text-4xl md:text-5xl mb-6" style={{ fontFamily: 'Poppins', fontWeight: 800 }}>
                  Waarom <span className="text-cyan-400">vaste gezichten</span> cruciaal zijn
                </h2>
                <p className="text-xl text-gray-400 mb-8" style={{ fontFamily: 'Poppins' }}>
                  Bij een evenementenlocatie als Lofi draait het om beleving. Gasten voelen het verschil wanneer je team je locatie door en door kent.
                </p>
                
                <div className="space-y-4">
                  {[
                    "Medewerkers kennen de looplijnen en opzet",
                    "Gasten ervaren een consistente beleving",
                    "Geen kostbare tijd kwijt aan inwerken",
                    "Het team voelt als onderdeel van Lofi"
                  ].map((item, i) => (
                    <motion.div
                      key={item}
              ...
              >
                <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-xl border border-cyan-500/30 rounded-2xl p-8">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      <h4 className="text-white font-bold text-lg" style={{ fontFamily: 'Poppins' }}>Hoe het werkt</h4>
                      <p className="text-gray-400 text-sm" style={{ fontFamily: 'Poppins' }}>Vaste poule voor Lofi</p>
                    </div>
                  </div>
                  
                  <div className="space-y-3">
                    {[
                      { step: "1", title: "Wij selecteren toppers", desc: "Op basis van jouw wensen" },
                      { step: "2", title: "Eerste diensten samen", desc: "Kennismaking met je locatie" },
                      { step: "3", title: "Favorieten markeren", desc: "Jij kiest wie terugkomt" },
                      { step: "4", title: "Vaste poule staat", desc: "Steeds dezelfde gezichten" },
                    ].map((item) => (
                      <div key={item.step} className="flex items-center gap-4 bg-gray-800/60 rounded-lg px-4 py-3">
                        <div className="w-10 h-10 bg-gradient-to-br from-cyan-500 to-cyan-700 rounded-full flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
                          {item.step}
                        </div>
                        <div>
                          <span className="text-white font-semibold" style={{ fontFamily: 'Poppins' }}>{item.title}</span>
          ...
          >
            ...
            >
              ...
              <p className="text-xl text-gray-400 max-w-3xl mx-auto" style={{ fontFamily: 'Poppins' }}>
                Gespecialiseerd personeel voor al je events bij Lofi
              </p>
            </motion.div>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-5xl">
              {[
                {
                  emoji: "🍽️",
                  title: "Horeca-toppers",
                  desc: "Ervaren bediening die weet hoe je locatie werkt. Representatief, flexibel en EXTRA gastgericht.",
                  color: "from-purple-600 to-purple-800"
                },
                {
                  emoji: "👨‍🍳",
                  title: "Keukenpersoneel",
                  desc: "Van afwas tot sous-chef: professionals die je keuken draaiende houden, ook tijdens piekmomenten.",
                  color: "from-orange-600 to-orange-800"
                },
                {
                  emoji: "🍸",
                  title: "Bartoppers",
                  desc: "Vakkundige bartenders die zorgen voor een vlekkeloze service aan de bar. Snel, vriendelijk en EXTRA stijlvol.",
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl">
              ...
              >
                <div className="inline-flex items-center gap-2 bg-purple-600/20 border border-purple-500/40 rounded-full px-4 py-2 mb-6">
                  ...
                  <span className="text-purple-300 text-sm" style={{ fontFamily: 'Poppins' }}>Continuïteit</span>
                </div>
                <h2 className="text-4xl md:text-5xl mb-6" style={{ fontFamily: 'Poppins', fontWeight: 800 }}>
                  Dezelfde <span className="text-purple-400">gezichten</span>, steeds weer
                </h2>
                <p className="text-xl text-gray-400 mb-8" style={{ fontFamily: 'Poppins' }}>
                  Geen eindeloos inwerken. Wij zorgen dat Lofi zoveel mogelijk dezelfde medewerkers ziet die jullie locatie al kennen.
                </p>
                
                <div className="space-y-4">
                  {[
                    "Stel je eigen favorietenpoule samen",
                    "Medewerkers kennen de looplijnen van Lofi",
                    "Geen tijd kwijt aan inwerken",
                    "Hogere productiviteit vanaf event één",
                    "Het team voelt als je eigen vaste crew"
                  ].map((item, i) => (
                    <motion.div
                      key={item}
                      initial={{ opacity: 0, x: -20 }}
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-xl border border-purple-500/30 rounded-2xl p-8">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      <h4 className="text-white font-bold text-lg" style={{ fontFamily: 'Poppins' }}>Je vaste Lofi-team</h4>
                      <p className="text-gray-400 text-sm" style={{ fontFamily: 'Poppins' }}>Gematchte medewerkers</p>
                    </div>
                  </div>
                  
                  <div className="space-y-3">
                    {["Anna B.", "Mohammed K.", "Lisa V.", "Thomas R.", "Sophie M."].map((name) => (
        ...
        {currentSlide === 4 && (
          ...
          >
            ...
            >
              ...
              <p className="text-xl text-gray-400 max-w-3xl mx-auto" style={{ fontFamily: 'Poppins' }}>
                Wij selecteren, trainen en behouden de beste mensen voor Lofi
              </p>
            </motion.div>
        ...
        {currentSlide === 7 && (
          ...
          >
            ...
            >
              ...
              <p className="text-xl text-gray-400 max-w-3xl mx-auto" style={{ fontFamily: 'Poppins' }}>
                Na elk event ontvangt de medewerker een beoordeling. Realtime inzicht in prestaties.
              </p>
            </motion.div>
          ...
          >
            <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl">
              ...
              >
                ...
                <p className="text-xl text-gray-400 mb-8" style={{ fontFamily: 'Poppins' }}>
                  Geen wachtrijen of keuzemenu's. Bij EXTRA heb je een vast contactpersoon die Lofi kent.
                </p>
                
                <div className="space-y-4">
                  {[
                    "Vaste accountmanager voor Lofi",
        ...
        {currentSlide === 10 && (
          ...
          >
            ...
            >
              ...
              >
                <img src={extraLogoWit} alt="EXTRA" className="h-12" />
                <span className="text-2xl text-gray-500 font-light" style={{ fontFamily: 'Poppins' }}>×</span>
                <img 
                  src={logoLofi} 
                  alt="Lofi" 
                  className="h-14"
              ...
              <motion.h2
                ...
                style={{ fontFamily: 'Poppins', fontWeight: 800 }}
              >
                Klaar voor je <span className="text-purple-400">vaste team</span>?
              </motion.h2>
              ...
              <motion.p
                ...
                style={{ fontFamily: 'Poppins' }}
              >
                Laten we samen een vast team opbouwen voor Lofi
              </motion.p>
