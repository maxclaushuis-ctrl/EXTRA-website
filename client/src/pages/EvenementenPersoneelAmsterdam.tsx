...
import { ArrowRight, PartyPopper, Check, Sparkles, Clock, Shield, Star } from "lucide-react";

export default function EvenementenPersoneelAmsterdam() {
  return (
      ...
      <main>
        ...
        <section className="py-24 bg-[#0d0415]">
          <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
            <RevealSection className="mb-16">
              <h2 className="text-3xl sm:text-5xl font-black text-white mb-6">Wat wij leveren voor <span className="text-purple-500">events</span></h2>
              <p className="text-lg text-purple-100/60 max-w-2xl">Onze medewerkers maken het verschil op uw evenement.</p>
            </RevealSection>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                { title: "Barpersoneel", icon: Shield, desc: "Ervaren barkeepers die onder druk kunnen presteren." },
              ].map((service, i) => (
        ...
        <section className="py-24 bg-[#0a0310] relative">
          <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
              ...
              {[
                { step: "01", title: "Inventarisatie", desc: "Samen bekijken we de behoeften van uw specifieke evenement." },
                { step: "02", title: "Briefing", desc: "Ons team wordt uitgebreid gebrieft op uw wensen en huisstijl." },
                { step: "03", title: "Executie", desc: "Topkwaliteit personeel op locatie voor een vlekkeloos verloop." },
              ].map((item, i) => (
        ...
        <section className="py-24 bg-gradient-to-r from-purple-900/40 to-pink-900/40 border-y border-white/5">
          <div className="max-w-4xl mx-auto px-5 text-center">
            <RevealSection>
              <h2 className="text-3xl sm:text-5xl font-black mb-8">Maak uw event onvergetelijk</h2>
              <p className="text-xl text-purple-100/70 mb-10">Met het personeel van EXTRA bent u verzekerd van kwaliteit en enthousiasme.</p>
