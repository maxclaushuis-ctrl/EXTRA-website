      ...
      <AnimatePresence mode="wait">
        ...
        {currentSlide === 0 && (
          ...
          >
            ...
            >
              Je partner in kwalitatief eventpersoneel
            </motion.p>
          ...
          >
            ...
            >
              ...
              <p className="text-xl text-gray-400 max-w-3xl mx-auto" style={{ fontFamily: 'Poppins' }}>
                Gespecialiseerd personeel voor al je events en cateringklussen
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  desc: "Ervaren bediening voor events, conferenties en recepties. Representatief, flexibel en EXTRA gastgericht.",
        ...
        {currentSlide === 2 && (
          ...
          >
            ...
            >
              ...
              <p className="text-xl text-gray-400 max-w-3xl mx-auto" style={{ fontFamily: 'Poppins' }}>
                Wij selecteren, trainen en behouden de beste mensen voor jouw events
              </p>
            </motion.div>
          ...
          >
            <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl">
              ...
              >
                ...
                <p className="text-xl text-gray-400 mb-8" style={{ fontFamily: 'Poppins' }}>
                  Geen eindeloos inwerken. Wij zorgen dat je zoveel mogelijk dezelfde medewerkers ziet die je locatie al kennen.
                </p>
          ...
          >
            <div className="grid md:grid-cols-2 gap-16 items-center max-w-6xl">
              ...
              >
                ...
                <p className="text-xl text-gray-400 mb-8" style={{ fontFamily: 'Poppins' }}>
                  Geen wachtrijen of keuzemenu's. Bij EXTRA heb je een vast contactpersoon die je events kent.
                </p>
        ...
        {currentSlide === 9 && (
          ...
          >
            ...
            >
              ...
              <p className="text-xl text-gray-400 max-w-3xl mx-auto" style={{ fontFamily: 'Poppins' }}>
                Toonaangevende eventlocaties en cateraars vertrouwen op EXTRA
              </p>
            </motion.div>
          ...
          >
            ...
            >
              ...
              <motion.p
                ...
                style={{ fontFamily: 'Poppins' }}
              >
                Ontdek hoe EXTRA je personeelszorgen bij events wegneemt
              </motion.p>
