...
const appScreens = [
  { key: "dashboard", img: screenDashboard, label: "Dashboard", alt: "Schermafbeelding van het EXTRAATje-dashboard in de app van restaurantmedewerkers: puntensaldo, bronsstatus en populaire beloningen" },
  ...
  { key: "ranglijst", img: screenRanglijst, label: "Ranglijst", alt: "Schermafbeelding van de ranglijst in de EXTRAATje-app met de puntenposities van restaurantmedewerkers" },
];
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 w-full pt-28 sm:pt-32 pb-36 sm:pb-32">
          <div className="max-w-2xl">
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-6xl text-white leading-[1.1] mb-5 sm:mb-8" style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 900 }}>
              Horecapersoneel nodig<br />
              voor jouw restaurant?<br />
